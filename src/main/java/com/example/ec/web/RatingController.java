...
public class RatingController {
    ...
    public List<RatingDto> getAll() {
        ...
        return tourRatingService.lookupAll().stream().map(t -> new RatingDto(t.getScore(), t.getComment(), t.getCustomerId())).collect(Collectors.toList());
    }
    ...
    public RatingDto getRating(@PathVariable("id") Integer id) {
        ...
        return tourRatingService.lookupRatingById(id).map(t -> new RatingDto(t.getScore(), t.getComment(), t.getCustomerId())).orElseThrow(() -> new NoSuchElementException("Rating " + id + " not found"));
    }
